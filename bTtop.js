...
function sendMessage() {
    ...
    if (input.value.trim() !== "") {
        ...
        //     reply.innerHTML = `<span style="background: #eee; color: #333; padding: 8px 12px; border-radius: 15px; display: inline-block; font-size: 0.85rem;">Good day! A baker will get back to you shortly.</span>`;
